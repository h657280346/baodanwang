                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <form method="post" class="form-horizontal" action="./successUpdate.action" enctype="multipart/form-data">
                                    <input type="hidden" name="id" value="${requestScope.success.id }">
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">标题</label>

                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="title" value="${requestScope.success.title }">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text"  class="form-control" name="author" value="${requestScope.success.author }" required="" aria-required="true">
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text"  class="form-control" name="priority" value="${requestScope.success.priority }" required="" aria-required="true">
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>                                    
                                    <div class="form-group">
                                    ...
                                    <div class="form-group" id="fig" style="display:none">
                                     ...
                                     <div id="imagePreview1" class="form-group" align="center">
										<img src="${requestScope.success.figure }">
									</div>
									<input type="hidden" name="figure" id="hf" value="${requestScope.success.figure }"/>
                                    ...
                                    <div id="imagePreview" class="form-group" align="center">   
										<img src="${requestScope.success.picture }">
									</div>
                                    <input type="hidden" name="picture" value="${requestScope.success.picture }"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                        	<script id="container" name="introduction" type="text/plain" style="height:500px">
    											${requestScope.success.introduction}
											</script>
    										<!-- 配置文件 -->
