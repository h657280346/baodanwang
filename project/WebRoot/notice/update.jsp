...
<body>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <form method="post" class="form-horizontal" action="./noticeUpdate.action" enctype="multipart/form-data">
                                    <div class="form-group">
                                    <input type="hidden" name="id" value="${notice.id }">
                                        <label class="col-sm-2 control-label">标题</label>

                                        <div class="col-sm-10">
                                            <input type="text" value="${notice.title }" class="form-control" name="title" required="" aria-required="true">
                                        </div>
                                    </div>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" value="${notice.priority }" class="form-control" name="priority" required="" aria-required="true">
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>                                    
                                    ...
                                    <div class="form-group" id="fig" style="display:none">
                                      ...
                                      <div class="div1 col-sm-10" >
    										 <input type="text" value="${notice.videourl }"  class="form-control" name="videourl" >
										</div>
                                    </div>
                                    <div class="hr-line-dashed"></div>	
									<div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea   class="form-control" name="introduce" required="" aria-required="true">}</textarea>
                                        </div>
                                    </div>
                                   <div class="hr-line-dashed"></div>
                                    <div class="form-group">
	...
	$(document).ready(function () {
		...
		if(null!='${notice.videourl }'&&""!='${notice.videourl }'){
