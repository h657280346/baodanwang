 ...
 * Generated at: 2018-04-20 01:30:00 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.myAjax.user;
...
return;
    ...
    try {
      ...
      out.write("<title>逸尘智创后台管理系统-用户管理</title>\r\n");
      out.write("<style>\r\n");
      ...
      out.write("\t\t\t\t<i class=\"fa-fw fa fa-user\"></i> 用户 <span>> 用户管理 </span>\r\n");
      out.write("\t\t\t</h1>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<!-- end col -->\r\n");
      out.write("\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\turl : 'userList.action',\r\n");
      out.write("\t\t\t\t\t\t\tediturl : \"updataUser.action\",\r\n");
      out.write("\t\t\t\t\t\t\tcolNames : [ '用户ID', 'openid', '头像', '昵称', '微信号',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t'电话', '地址', '详细地址', '真实姓名', '添加时间' ],\r\n");
      out.write("\t\t\t\t\t\t\tcolModel : [ {\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\tkey:true\r\n");
      out.write("\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\tname : 'userOpenid',\r\n");
      out.write("\t\t\t\t\t\t\t\tindex : 'user_openid',\r\n");
      out.write("\t\t\t\t\t\t\t\talign : \"center\",\r\n");
      out.write("\t\t\t\t\t\t\t\tsortable : false,\r\n");
      out.write("\t\t\t\t\t\t\t\teditable : true,\r\n");
      out.write("\t\t\t\t\t\t\t\twidth : \"200\"\r\n");
      out.write("\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\tname : 'userAvatarurl',\r\n");
      out.write("\t\t\t\t\t\t\t\tindex : 'user_avatarUrl',\r\n");
      out.write("\t\t\t\t\t\t\t\talign : \"center\",\r\n");
      out.write("\t\t\t\t\t\t\t\tsortable : false,\r\n");
      out.write("\t\t\t\t\t\t\t\teditable : true,\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\tindex : 'user_nickName',\r\n");
      out.write("\t\t\t\t\t\t\t\talign : \"center\",\r\n");
      out.write("\t\t\t\t\t\t\t\tsortable : false,\r\n");
      out.write("\t\t\t\t\t\t\t\teditable : true\r\n");
      out.write("\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\tname : 'userWechatid',\r\n");
      out.write("\t\t\t\t\t\t\t\tindex : 'user_weChatId',\r\n");
      out.write("\t\t\t\t\t\t\t\talign : \"center\",\r\n");
      out.write("\t\t\t\t\t\t\t\tsortable : false,\r\n");
      out.write("\t\t\t\t\t\t\t\teditable : true\r\n");
      out.write("\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\tname : 'userTel',\r\n");
      out.write("\t\t\t\t\t\t\t\tindex : 'user_tel',\r\n");
      out.write("\t\t\t\t\t\t\t\talign : \"center\",\r\n");
      out.write("\t\t\t\t\t\t\t\tsortable : false,\r\n");
      out.write("\t\t\t\t\t\t\t\teditable : true\r\n");
      out.write("\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\tname : 'userAddress',\r\n");
      out.write("\t\t\t\t\t\t\t\tindex : 'user_address',\r\n");
      out.write("\t\t\t\t\t\t\t\talign : \"center\",\r\n");
      out.write("\t\t\t\t\t\t\t\tsortable : false,\r\n");
      out.write("\t\t\t\t\t\t\t\teditable : true\r\n");
      out.write("\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\tname : 'userAddressdetail',\r\n");
      out.write("\t\t\t\t\t\t\t\tindex : 'user_addressDetail',\r\n");
      out.write("\t\t\t\t\t\t\t\talign : \"center\",\r\n");
      out.write("\t\t\t\t\t\t\t\tsortable : false,\r\n");
      out.write("\t\t\t\t\t\t\t\teditable : true\r\n");
      out.write("\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\tname : 'userRealname',\r\n");
      out.write("\t\t\t\t\t\t\t\tindex : 'user_realName',\r\n");
      out.write("\t\t\t\t\t\t\t\talign : \"center\",\r\n");
      out.write("\t\t\t\t\t\t\t\tsortable : false,\r\n");
      out.write("\t\t\t\t\t\t\t\teditable : true\r\n");
      out.write("\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\tname : 'userAddtime',\r\n");
      out.write("\t\t\t\t\t\t\t\tindex : 'user_addTime',\r\n");
      out.write("\t\t\t\t\t\t\t\talign : \"center\",\r\n");
