                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <form method="post" class="form-horizontal" action="./carouselUpdate.action" enctype="multipart/form-data">
                                    <div class="form-group">
                                     <input type="hidden" name="id" value="${carousel.id }">
                                        <label class="col-sm-2 control-label">标题</label>

                                        <div class="col-sm-10">
                                            <input type="text" value="${carousel.title }" class="form-control" name="title" required="" aria-required="true">
                                        </div>
                                    </div>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number"  value="${carousel.priority }" class="form-control" name="priority" required="" aria-required="true">
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>                                    
                                    ...
                                    <div class="form-group" id="fig" style="display:none">
                                        ...
                                        <div class="div1 col-sm-10" >
    										 ...
    										 <input type="text"  value="${carousel.videourl }" class="form-control" name="videourl" >
                                    ...
                                    <div class="form-group">
										...
										<div class="div1 col-sm-10">
    										...
    										<input type="hidden" name="picture" value="${carousel.img }" >
    										<input type="file" class="inputstyle" name="myPhoto" onchange="loadImageFile()" id="imageInput"  aria-required="true">
										</div>
									...
									<div class="form-group">
                                        <label class="col-sm-2 control-label">介绍</label>
                                         <div class="col-sm-10">
                                            <textarea   class="form-control" name="introduce" required="" aria-required="true">${carousel.introduce}</textarea>
                                        </div>
                                    </div>
