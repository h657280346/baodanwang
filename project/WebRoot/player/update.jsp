                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <form method="post" class="form-horizontal" action="./playerUpdate.action" enctype="multipart/form-data">
                                    <div class="form-group">
                                     <input type="hidden" name="id" value="${player.id }">
                                        <label class="col-sm-2 control-label">球员openId</label>

                                        <div class="col-sm-10">
                                            <input type="text"  class="form-control" value="${player.openid }"  name="openid" required="" aria-required="true">
                                        </div>
                                    </div>
                              <div class="hr-line-dashed"></div>
									
									<div class="form-group">
                                        <label class="col-sm-2 control-label">球员微信昵称</label>

                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" value="${player.nickname }" name="nickname" required="" aria-required="true">
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>
									
									<div class="form-group">
                                        <label class="col-sm-2 control-label">球员微信头像</label>

                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" value="${player.logourl }" name="logourl" required="" aria-required="true">
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>
									
									<div class="form-group">
                                        <label class="col-sm-2 control-label">赛事Id</label>

                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" value="${player.matchid }" name="matchid" required="" aria-required="true">
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>	
									<div class="form-group">
                                        <label class="col-sm-2 control-label">球员状态</label>

                                        <div class="col-sm-10">
                                            <input type="text"  class="form-control" value="${player.status }" name="status" required="" aria-required="true">
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>	
									<div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text"  class="form-control" value="${player.identity }"  name="identity" required="" aria-required="true">
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>	
									<div class="form-group">
                                        <label class="col-sm-2 control-label">参加时间</label>

                                        <div class="col-sm-10">
                                            <input type="text"  class="form-control"  value="${player.time }" name="time" required="" aria-required="true">
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>	
									<div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text"  class="form-control" value="${player.notes }" name="notes" required="" aria-required="true">
                                        </div>
                                    </div>
                                      <div class="hr-line-dashed"></div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                        	<script id="container" name="notes" type="text/plain" style="height:500px">
