...
<body>
                            ...
                            <div class="ibox-content">
                                ...
                                <table class="table table-striped table-bordered table-hover dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach items="${requestScope.interestings}"  var="item" varStatus="status">
                                        <tr class="gradeX">
                                            <td class="center" style="align-items: center"> <input type="checkbox" name="del" value="${item.id }" style="align:center"/></td>
                                            <td><a href="./findInterestingById.action?id=${item.id }">${item.title}</a></td>
											<td>${item.time }</td>
                                            <td>${item.view }</td>
                                            <td>${item.priority }</td>
	...
	<script type="text/javascript">
		function add(){
			window.location.href="./skipInteresting.action";
		}
		function update(id){
			window.location.href="./findInterestingById.action?id="+id;
		}
		function dele(id){
			if(confirm("此操作不可逆，是否继续执行？"))
			window.location.href="./interestingDelete.action?id="+id;
		}
		function del(){
			if(confirm("此操作不可逆，是否继续执行？")){
