...
<body>
                                ...
                                <table class="table table-striped table-bordered table-hover dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="gradeX">
                                            ...
                                            <td><a href="./findCarouselById.action?id=${item.id }">${item.title}</a></td>
	...
	<script type="text/javascript">
		function add(){
			window.location.href="./skipCarousel.action";
		}
		function update(id){
			window.location.href="./findCarouselById.action?id="+id;
		}
		function dele(id){
			if(confirm("此操作不可逆，是否继续执行？"))
			window.location.href="./carouselDelete.action?id="+id;
		}
		function del(){
			if(confirm("此操作不可逆，是否继续执行？")){
