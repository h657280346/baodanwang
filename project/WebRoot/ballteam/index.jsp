...
<body>
                            ...
                            <div class="ibox-content">
                                ...
                                <table class="table table-striped table-bordered table-hover dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach items="${ballteams}"  var="item" varStatus="status">
                                        <tr class="gradeX">
	...
	<script type="text/javascript">
		function add(){
			window.location.href="./skipBallteam.action";
		}
		function update(id){
			window.location.href="./findBallteamById.action?id="+id;
		}
		function dele(id){
			if(confirm("此操作不可逆，是否继续执行？"))
			window.location.href="./ballteamDelete.action?id="+id;
		}
		function del(){
			if(confirm("此操作不可逆，是否继续执行？")){
