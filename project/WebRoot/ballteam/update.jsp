...
<body>
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li class="active">
                        <a href="./ballteamShow.action"><i class="fa fa-flask"></i> <span class="nav-label">球队</span></a>
                    </li>
                    <li >
                        <a href="./playerShow.action"><i class="fa fa-flask"></i> <span class="nav-label">球员</span></a>
                    </li>
                     <li >
                        <a href="./subscriberShow.action"><i class="fa fa-flask"></i> <span class="nav-label">用户</span></a>
                    </li>
                     <li >
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <form method="post" class="form-horizontal" action="./ballteamUpdate.action" enctype="multipart/form-data">
                                    <div class="form-group">
                                     <input type="hidden" name="id" value="${ballteam.id }">
                                        <label class="col-sm-2 control-label">用户openID</label>

                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" value="${ballteam.openid }" name="openid" required="" aria-required="true">
                                        </div>
                                    </div>
                                      <div class="hr-line-dashed"></div>
									<div class="form-group">
                                        <label class="col-sm-2 control-label">球队名称</label>

                                        <div class="col-sm-10">
                                            <input type="text"  class="form-control" value="${ballteam.team }" name="team" required="" aria-required="true">
                                        </div>
                                    </div>
                                      <div class="hr-line-dashed"></div>
									<div class="form-group">
                                        <label class="col-sm-2 control-label">球队简称</label>

                                        <div class="col-sm-10">
                                            <input type="text"  class="form-control" value="${ballteam.abbreviation }" name="abbreviation" required="" aria-required="true">
                                        </div>
                                    </div>
                                       <div class="hr-line-dashed"></div>
									<div class="form-group">
                                        <label class="col-sm-2 control-label">球队区域</label>

                                        <div class="col-sm-10">
                                            <input type="text"  class="form-control" value="${ballteam.area }" name="area" required="" aria-required="true">
                                        </div>
                                    </div>
                                     <div class="hr-line-dashed"></div>
									<div class="form-group">
                                        <label class="col-sm-2 control-label">球队创建日期</label>

                                        <div class="col-sm-10">
                                            <input type="text"  class="form-control" value="${ballteam.teamdate }" name="teamdate" required="" aria-required="true">
                                        </div>
                                    </div>
                                     <div class="hr-line-dashed"></div>
                                      <div class="form-group">
                                        <label class="col-sm-2 control-label">球队头像</label>

                                        <div class="div1 col-sm-10" >
    										<div class="div2 btn btn-w-m btn-info">上传头像</div>
    										<input type="hidden" name="old-teamimg" value="${ballteam.teamimg }">
    										<input type="file" class="inputstyle" name="teamimg" onchange="loadImageFile1()" id="imageInput1" >
										</div>
	...
	$(document).ready(function () {
	 if(null!='${ballteam.teamimg }'&&""!='${ballteam.teamimg }'){
		var newPreview = document.getElementById("imagePreview1");   
		oPreviewImg = new Image();   
		oPreviewImg.style.width = "400px";   
		oPreviewImg.style.height = "280px";
		oPreviewImg.src = '${ballteam.teamimg }';      
		newPreview.appendChild(oPreviewImg);	
	} 
		var flag = false;
