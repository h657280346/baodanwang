...
<body>
                            ...
                            <div class="ibox-content">
                                ...
                                <table class="table table-striped table-bordered table-hover dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach items="${subscribers}"  var="item" varStatus="status">
                                        <tr class="gradeX">
                                            <td class="center" style="align-items: center"> <input type="checkbox" name="del" value="${item.id }" style="align:center"/></td>
                                            <td><a href="./findSubscriberById.action?openid=${item.openid}">${item.openid}</a></td>
                                            <td>${item.nickname }</td>
											<td>${item.phone }</td>
                                             <td>${item.success } </td>
	...
	<script type="text/javascript">
		function add(){
			window.location.href="./skipSubscriber.action";
		}
		function update(id){
			window.location.href="./findSubscriberById.action?id="+id;
		}
		function dele(id){
			if(confirm("此操作不可逆，是否继续执行？"))
			window.location.href="./subscriberDelete.action?id="+id;
		}
		function del(){
			if(confirm("此操作不可逆，是否继续执行？")){
