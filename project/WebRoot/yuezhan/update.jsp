                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <form method="post" class="form-horizontal" action="./yuezhanUpdate.action" enctype="multipart/form-data">
                                    <div class="form-group">
                                     <input type="hidden" name="id" value="${yuezhan.id }">
                                        <label class="col-sm-2 control-label">用户openId</label>

                                        <div class="col-sm-10">
                                            <input type="text"  class="form-control" value="${yuezhan.openid }"  name="openid" required="" aria-required="true">
                                        </div>
                                    </div>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" value="${yuezhan.matchid }" name="matchid" required="" aria-required="true">
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>	
									<div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text"  class="form-control" value="${yuezhan.identity }" name="identity" required="" aria-required="true">
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>	
									<div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number"  class="form-control"  value="${yuezhan.number }" name="number" required="" aria-required="true">
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>	
									<div class="form-group">
                                        <label class="col-sm-2 control-label">分享备注</label>

                                        <div class="col-sm-10">
                                            <textarea   class="form-control" name="sharenotes" required="" aria-required="true"> ${yuezhan.sharenotes }</textarea>
                                        </div>
                                    </div>
                                     <div class="hr-line-dashed"></div>	
									<div class="form-group">
                                        <label class="col-sm-2 control-label">取消备注</label>

                                        <div class="col-sm-10">
                                            <textarea   class="form-control" name="cancelnotes" required="" aria-required="true"> ${yuezhan.cancelnotes }</textarea>
                                        </div>
                                    </div>
