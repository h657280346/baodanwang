                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <form method="post" class="form-horizontal" action="./subscriberAdd.action" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
										...
										<div class="div1 col-sm-10">
    										...
    										<input type="file" class="inputstyle" name="avatar" onchange="loadImageFile()" id="imageInput" required="" aria-required="true">
										</div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number"  class="form-control" name="success" required="" aria-required="true">
                                        </div>
                                    </div>
