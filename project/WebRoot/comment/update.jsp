                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <form method="post" class="form-horizontal" action="./commentUpdate.action" enctype="multipart/form-data">
                                    <div class="form-group">
                                     <input type="hidden" name="id" value="${comment.id }">
                                        <label class="col-sm-2 control-label">用户openId</label>

                                        <div class="col-sm-10">
                                            <input type="text"  class="form-control" value="${comment.openid }"  name="openid" required="" aria-required="true">
                                        </div>
                                    </div>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" value="${comment.matchid }" name="matchid" required="" aria-required="true">
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">评论球队Id</label>

                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" value="${comment.teamid }" name="teamid" required="" aria-required="true">
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>	
									<div class="form-group">
                                        <label class="col-sm-2 control-label">评论详细</label>

                                        <div class="col-sm-10">
                                           <textarea   class="form-control"  name="detail" required="" aria-required="true">${comment.detail }</textarea>
                                            
                                        </div>
                                    </div>
                                   <div class="hr-line-dashed"></div>	
									<div class="form-group">
                                        <label class="col-sm-2 control-label">其他评论</label>

                                        <div class="col-sm-10">
                                            <input type="text"  class="form-control" value="${comment.other }" name="other" required="" aria-required="true">
                                        </div>
                                    </div>
                                     <div class="hr-line-dashed"></div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">评论星级</label>

                                        <div class="col-sm-10">
                                            <input type="number" class="form-control" value="${comment.star }" name="star" required="" aria-required="true">
                                        </div>
                                    </div>
