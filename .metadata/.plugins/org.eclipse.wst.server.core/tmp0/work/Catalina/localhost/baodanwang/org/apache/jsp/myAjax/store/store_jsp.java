 ...
 * Generated at: 2018-04-20 01:30:03 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.myAjax.store;
...
return;
    ...
    try {
      ...
      out.write("<title>逸尘智创后台管理系统-商铺管理</title>\r\n");
      out.write("<style>\r\n");
      ...
      out.write("\t\t\t\t<i class=\"fa-fw fa fa-building\"></i> 商铺 <span>> 商铺管理 </span>\r\n");
      out.write("\t\t\t</h1>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<!-- end col -->\r\n");
      out.write("\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\turl : 'storeList.action',\r\n");
      out.write("\t\t\t\t\t\t\tediturl : \"updataStore.action\",\r\n");
      out.write("\t\t\t\t\t\t\tcolNames : [ '商铺ID', 'openid', '商铺名称', '商铺昵称',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t'商铺头像', '商铺地址', '商铺详细地址', '商铺自提点','自提点详细地址', '电话',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t'微信号', '二维码', '余额', '是否认证', '认证类型', '认证名称',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t'认证照片', '创建时间' ],\r\n");
      out.write("\t\t\t\t\t\t\tcolModel : [ {\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\tkey : true\r\n");
      out.write("\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\tname : 'storeOpenid',\r\n");
      out.write("\t\t\t\t\t\t\t\tindex : 'store_openid',\r\n");
      out.write("\t\t\t\t\t\t\t\talign : \"center\",\r\n");
      out.write("\t\t\t\t\t\t\t\tsortable : false,\r\n");
      out.write("\t\t\t\t\t\t\t\teditable : false\r\n");
      out.write("\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\tname : 'storeName',\r\n");
      out.write("\t\t\t\t\t\t\t\tindex : 'store_name',\r\n");
      out.write("\t\t\t\t\t\t\t\talign : \"center\",\r\n");
      out.write("\t\t\t\t\t\t\t\tsortable : false,\r\n");
      out.write("\t\t\t\t\t\t\t\teditable : true\r\n");
      out.write("\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\tname : 'storeNickname',\r\n");
      out.write("\t\t\t\t\t\t\t\tindex : 'store_nickName',\r\n");
      out.write("\t\t\t\t\t\t\t\talign : \"center\",\r\n");
      out.write("\t\t\t\t\t\t\t\tsortable : false,\r\n");
      out.write("\t\t\t\t\t\t\t\teditable : false\r\n");
      out.write("\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\tname : 'storeAvatarurl',\r\n");
      out.write("\t\t\t\t\t\t\t\tindex : 'store_avatarUrl',\r\n");
      out.write("\t\t\t\t\t\t\t\talign : \"center\",\r\n");
      out.write("\t\t\t\t\t\t\t\tsortable : false,\r\n");
      out.write("\t\t\t\t\t\t\t\teditable : false,\r\n");
      ...
      out.write("\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\tname : 'storeAddress',\r\n");
      out.write("\t\t\t\t\t\t\t\tindex : 'store_address',\r\n");
      out.write("\t\t\t\t\t\t\t\talign : \"center\",\r\n");
      out.write("\t\t\t\t\t\t\t\tsortable : false,\r\n");
      out.write("\t\t\t\t\t\t\t\teditable : true\r\n");
      out.write("\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\tname : 'storeAddressdetail',\r\n");
      out.write("\t\t\t\t\t\t\t\tindex : 'store_addressDetail',\r\n");
      out.write("\t\t\t\t\t\t\t\talign : \"center\",\r\n");
      out.write("\t\t\t\t\t\t\t\tsortable : false,\r\n");
      out.write("\t\t\t\t\t\t\t\teditable : true\r\n");
      out.write("\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\tname : 'storePickupsite',\r\n");
      out.write("\t\t\t\t\t\t\t\tindex : 'store_pickUpSite',\r\n");
      out.write("\t\t\t\t\t\t\t\talign : \"center\",\r\n");
      out.write("\t\t\t\t\t\t\t\tsortable : false,\r\n");
      out.write("\t\t\t\t\t\t\t\teditable : true\r\n");
      out.write("\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\tname : 'storePickupsitedetail',\r\n");
      out.write("\t\t\t\t\t\t\t\tindex : 'store_pickUpSiteDetail',\r\n");
      out.write("\t\t\t\t\t\t\t\talign : \"center\",\r\n");
      out.write("\t\t\t\t\t\t\t\tsortable : false,\r\n");
      out.write("\t\t\t\t\t\t\t\teditable : true\r\n");
      out.write("\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\tname : 'storeTel',\r\n");
      out.write("\t\t\t\t\t\t\t\tindex : 'store_tel',\r\n");
      out.write("\t\t\t\t\t\t\t\talign : \"center\",\r\n");
      out.write("\t\t\t\t\t\t\t\tsortable : false,\r\n");
      out.write("\t\t\t\t\t\t\t\teditable : true\r\n");
      out.write("\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\tname : 'storeWechatid',\r\n");
      out.write("\t\t\t\t\t\t\t\tindex : 'store_weChatId',\r\n");
      out.write("\t\t\t\t\t\t\t\talign : \"center\",\r\n");
      out.write("\t\t\t\t\t\t\t\tsortable : false,\r\n");
      out.write("\t\t\t\t\t\t\t\teditable : true\r\n");
      out.write("\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\tname : 'storeQrcode',\r\n");
      out.write("\t\t\t\t\t\t\t\tindex : 'store_QRCode',\r\n");
      out.write("\t\t\t\t\t\t\t\talign : \"center\",\r\n");
      out.write("\t\t\t\t\t\t\t\tsortable : false,\r\n");
      out.write("\t\t\t\t\t\t\t\teditable : false,\r\n");
      out.write("\t\t\t\t\t\t\t\tsearch : false,\r\n");
      out.write("\t\t\t\t\t\t\t\tformatter : imageFormat1\r\n");
      out.write("\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\tname : 'balance',\r\n");
      out.write("\t\t\t\t\t\t\t\tindex : 'balance',\r\n");
      out.write("\t\t\t\t\t\t\t\talign : \"center\",\r\n");
      out.write("\t\t\t\t\t\t\t\tsortable : true,\r\n");
      out.write("\t\t\t\t\t\t\t\teditable : true,\r\n");
      out.write("\t\t\t\t\t\t\t\tsearch : true\r\n");
      out.write("\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\tname : 'storeRealnamestatus',\r\n");
      out.write("\t\t\t\t\t\t\t\tindex : 'store_realNameStatus',\r\n");
      out.write("\t\t\t\t\t\t\t\talign : \"center\",\r\n");
      out.write("\t\t\t\t\t\t\t\tsortable : false,\r\n");
      out.write("\t\t\t\t\t\t\t\teditable : true\r\n");
      out.write("\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\tname : 'storeRealnametype',\r\n");
      out.write("\t\t\t\t\t\t\t\tindex : 'store_realNameType',\r\n");
      out.write("\t\t\t\t\t\t\t\talign : \"center\",\r\n");
      out.write("\t\t\t\t\t\t\t\tsortable : false,\r\n");
      out.write("\t\t\t\t\t\t\t\teditable : true\r\n");
      out.write("\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\tname : 'storeRealname',\r\n");
      out.write("\t\t\t\t\t\t\t\tindex : 'store_realName',\r\n");
      out.write("\t\t\t\t\t\t\t\talign : \"center\",\r\n");
      out.write("\t\t\t\t\t\t\t\tsortable : false,\r\n");
      out.write("\t\t\t\t\t\t\t\teditable : true\r\n");
      out.write("\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\tname : 'storeCertificationpicture',\r\n");
      out.write("\t\t\t\t\t\t\t\tindex : 'store_certificationPicture',\r\n");
      out.write("\t\t\t\t\t\t\t\talign : \"center\",\r\n");
      out.write("\t\t\t\t\t\t\t\tsortable : false,\r\n");
      out.write("\t\t\t\t\t\t\t\teditable : false,\r\n");
      out.write("\t\t\t\t\t\t\t\tsearch : false,\r\n");
      out.write("\t\t\t\t\t\t\t\tformatter : imageFormat2\r\n");
      out.write("\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\tname : 'storeAddtime',\r\n");
      out.write("\t\t\t\t\t\t\t\tindex : 'store_addTime',\r\n");
      out.write("\t\t\t\t\t\t\t\talign : \"center\",\r\n");
      out.write("\t\t\t\t\t\t\t\tsortable : true,\r\n");
      out.write("\t\t\t\t\t\t\t\teditable : true\r\n");
      out.write("\t\t\t\t\t\t\t} ],\r\n");
      ...
      out.write("\t\t\t\t\t\t\t+ cellvalue\r\n");
      out.write("\t\t\t\t\t\t\t+ '\" style=\"border-radius:50%; width:40px;height:40px;\" />';\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\t;\r\n");
      out.write("\t\t\t\tfunction imageFormat1(cellvalue, options, rowObject) {\r\n");
      out.write("\t\t\t\t\treturn '<img src=\"'\r\n");
      out.write("\t\t\t\t\t\t\t+ cellvalue\r\n");
      out.write("\t\t\t\t\t\t\t+ '\" style=\"width:40px;height:40px;\" />';\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\t;\r\n");
      out.write("\t\t\t\tfunction imageFormat2(cellvalue, options, rowObject) {\r\n");
      out.write("\t\t\t\t\tvar values = cellvalue.split(',');\r\n");
      out.write("\t\t\t\t\tif (values[1] != null) {\r\n");
      out.write("\t\t\t\t\t\treturn '<img src=\"'\r\n");
      out.write("\t\t\t\t\t\t+ values[0]\r\n");
      out.write("\t\t\t\t\t\t+ '\"  style=\"width:40px;height:40px;margin-right:5px;\" /><img src=\"'\r\n");
      out.write("\t\t\t\t\t\t+ values[1]\r\n");
      out.write("\t\t\t\t\t\t+ '\"  style=\"width:40px;height:40px;margin-left:5px;\" />';\r\n");
      out.write("\t\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t\treturn '<img src=\"'\r\n");
      out.write("\t\t\t\t\t\t+ values[0]\r\n");
      out.write("\t\t\t\t\t\t+ '\"  style=\"width:40px;height:40px;margin-right:5px;\" />';\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\t;\r\n");
