...
<body>
                            ...
                            <div class="ibox-content">
                                ...
                                <table class="table table-striped table-bordered table-hover dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach items="${yuezhans}"  var="item" varStatus="status">
                                        <tr class="gradeX">
											...
											<c:if test="${item.identity=='p'}"><td>发布者</td></c:if>
											<c:if test="${item.identity=='m'}"><td>约战者</td></c:if>
											<c:if test="${(item.identity!='m'&&item.identity!='p')}"><td>${item.identity}</td></c:if>
                                            <td>${item.number } &nbsp;人</td>
                                            <td style="word-break: break-all;">${item.sharenotes } </td>
                                            <td style="word-break: break-all;">${item.cancelnotes }</td>
	...
	<script type="text/javascript">
		function add(){
			window.location.href="./skipYuezhan.action";
		}
		function update(id){
			window.location.href="./findYuezhanById.action?id="+id;
		}
		function dele(id){
			if(confirm("此操作不可逆，是否继续执行？"))
			window.location.href="./yuezhanDelete.action?id="+id;
		}
		function del(){
			if(confirm("此操作不可逆，是否继续执行？")){
