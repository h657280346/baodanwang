 ...
 * Generated at: 2018-04-20 00:53:15 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.myAjax.good;
...
return;
    ...
    try {
      ...
      out.write("<title>逸尘智创后台管理系统-商品管理</title>\r\n");
      out.write("<style>\r\n");
      ...
      out.write("\t\t\t\t<i class=\"fa-fw fa fa-cubes\"></i> 商品 <span>> 商品管理 </span>\r\n");
      out.write("\t\t\t</h1>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<!-- end col -->\r\n");
      out.write("\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\turl : 'goodList.action',\r\n");
      out.write("\t\t\t\t\t\t\tediturl : \"updataGood.action\",\r\n");
      out.write("\t\t\t\t\t\t\tcolNames : [ '商品ID', '归属商铺', '商品名称', '商品图片', '商品视频',\r\n");
      out.write("\t\t\t\t\t\t\t\t\t'商品描述', '商品价格', '商品团购价', '是否展示', '添加时间' ],\r\n");
      out.write("\t\t\t\t\t\t\tcolModel : [ {\r\n");
      out.write("\t\t\t\t\t\t\t\tname : 'goodId',\r\n");
      out.write("\t\t\t\t\t\t\t\tindex : 'good_id',\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\teditable : true\r\n");
      out.write("\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\tname : 'goodName',\r\n");
      out.write("\t\t\t\t\t\t\t\tindex : 'good_name',\r\n");
      out.write("\t\t\t\t\t\t\t\talign : \"center\",\r\n");
      out.write("\t\t\t\t\t\t\t\tsortable : false,\r\n");
      out.write("\t\t\t\t\t\t\t\teditable : true\r\n");
      out.write("\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\tname : 'image',\r\n");
      out.write("\t\t\t\t\t\t\t\tindex : 'image',\r\n");
      out.write("\t\t\t\t\t\t\t\talign : \"center\",\r\n");
      out.write("\t\t\t\t\t\t\t\tsortable : false,\r\n");
      out.write("\t\t\t\t\t\t\t\teditable : true,\r\n");
      out.write("\t\t\t\t\t\t\t\tsearch : false,\r\n");
      out.write("\t\t\t\t\t\t\t\tformatter : imageFormat,\r\n");
      out.write("\t\t\t\t\t\t\t/*edittype : \"custom\",\r\n");
      out.write("\t\t\t\t\t\t\teditoptions : {\r\n");
      out.write("\t\t\t\t\t\t\t\tcustom_element : my_input,\r\n");
      out.write("\t\t\t\t\t\t\t\tcustom_value : my_value\r\n");
      out.write("\t\t\t\t\t\t\t}*/\r\n");
      out.write("\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\tname : 'video',\r\n");
      out.write("\t\t\t\t\t\t\t\tindex : 'video',\r\n");
      out.write("\t\t\t\t\t\t\t\talign : \"center\",\r\n");
      out.write("\t\t\t\t\t\t\t\tsortable : false,\r\n");
      out.write("\t\t\t\t\t\t\t\teditable : true,\r\n");
      out.write("\t\t\t\t\t\t\t\tsearch : false,\r\n");
      out.write("\t\t\t\t\t\t\t\tformatter : videoFormat,\r\n");
      out.write("\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\tname : 'goodDescribe',\r\n");
      out.write("\t\t\t\t\t\t\t\tindex : 'good_describe',\r\n");
      out.write("\t\t\t\t\t\t\t\talign : \"center\",\r\n");
      out.write("\t\t\t\t\t\t\t\tsortable : false,\r\n");
      out.write("\t\t\t\t\t\t\t\teditable : true\r\n");
      out.write("\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\tname : 'goodPrice',\r\n");
      out.write("\t\t\t\t\t\t\t\tindex : 'good_price',\r\n");
      out.write("\t\t\t\t\t\t\t\talign : \"center\",\r\n");
      out.write("\t\t\t\t\t\t\t\tsortable : true,\r\n");
      out.write("\t\t\t\t\t\t\t\teditable : true\r\n");
      out.write("\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\tname : 'goodAdvanceprice',\r\n");
      out.write("\t\t\t\t\t\t\t\tindex : 'good_advancePrice',\r\n");
      out.write("\t\t\t\t\t\t\t\talign : \"center\",\r\n");
      out.write("\t\t\t\t\t\t\t\tsortable : true,\r\n");
      out.write("\t\t\t\t\t\t\t\teditable : true\r\n");
      out.write("\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\tname : 'goodShowstatus',\r\n");
      out.write("\t\t\t\t\t\t\t\tindex : 'good_showStatus',\r\n");
      out.write("\t\t\t\t\t\t\t\talign : \"center\",\r\n");
      out.write("\t\t\t\t\t\t\t\tsortable : false,\r\n");
      out.write("\t\t\t\t\t\t\t\teditable : true\r\n");
      out.write("\t\t\t\t\t\t\t}, {\r\n");
      out.write("\t\t\t\t\t\t\t\tname : 'goodAddtime',\r\n");
      out.write("\t\t\t\t\t\t\t\tindex : 'good_addTime',\r\n");
      out.write("\t\t\t\t\t\t\t\talign : \"center\",\r\n");
      out.write("\t\t\t\t\t\t\t\tsortable : true,\r\n");
      out.write("\t\t\t\t\t\t\t\teditable : true\r\n");
      out.write("\t\t\t\t\t\t\t} ],\r\n");
      ...
      out.write("\t\t\t\t\t\t\tsortname : 'good_addTime',\r\n");
      out.write("\t\t\t\t\t\t\tsortorder : \"desc\",\r\n");
      out.write("\t\t\t\t\t\t\ttoolbarfilter : true,\r\n");
      out.write("\t\t\t\t\t\t\tviewrecords : true,\r\n");
      out.write("\t\t\t\t\t\t\tcaption : \"商品信息\",\r\n");
      out.write("\t\t\t\t\t\t\tmultiselect : true,\r\n");
      out.write("\t\t\t\t\t\t\tmultiselectWidth : \"30\",\r\n");
      out.write("\t\t\t\t\t\t\tautowidth : true\r\n");
      out.write("\t\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t/*function my_input(value, options) {\r\n");
      out.write("\t\t\t\t\treturn $(\"<input type='file' multiple='multiple'/>\");\r\n");
      out.write("\t\t\t\t};\r\n");
      out.write("\t\t\t\tfunction my_value(value) {\r\n");
      out.write("\t\t\t\t\treturn \"value: \" + value.val();\r\n");
      out.write("\t\t\t\t};*/\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t+ '<img src=\"'\r\n");
      out.write("\t\t\t\t\t\t\t\t+ values[i].substring(6)\r\n");
      out.write("\t\t\t\t\t\t\t\t+ '\"  style=\"width:40px;height:40px;margin-right:3px;\" />'\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\treturn result;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\t;\r\n");
      out.write("\t\t\t\tfunction videoFormat(cellvalue, options, rowObject) {\r\n");
      out.write("\t\t\t\t\tvar values = cellvalue.split(',');\r\n");
      out.write("\t\t\t\t\tvar result = \"\";\r\n");
      out.write("\t\t\t\t\tfor (var i = 0; i < values.length; i++) {\r\n");
      out.write("\t\t\t\t\t\tresult = result\r\n");
      out.write("\t\t\t\t\t\t\t\t+ '<video src=\"'\r\n");
      out.write("\t\t\t\t\t\t\t\t+ values[i].substring(values[i].indexOf(\"!\") + 1)\r\n");
      out.write("\t\t\t\t\t\t\t\t+ '\" poster=\"'\r\n");
      out.write("\t\t\t\t\t\t\t\t+ values[i].substring(0, values[i].indexOf(\"!\"))\r\n");
      out.write("\t\t\t\t\t\t\t\t+ '\" style=\"width:40px;height:40px;object-fit:fill;margin-right:3px;\"/>'\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\treturn result;\r\n");
      out.write("\t\t\t\t}\r\n");
