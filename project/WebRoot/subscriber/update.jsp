...
<body>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <form method="post" class="form-horizontal" action="./subscriberUpdate.action" enctype="multipart/form-data">
                                    <div class="form-group">
                                     <input type="hidden" name="id" value="${subscriber.id }">
                                        <label class="col-sm-2 control-label">用户openID</label>

                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" value="${subscriber.openid }" name="openid" required="" aria-required="true">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
										...
										<div class="div1 col-sm-10">
    										...
    										<input type="hidden" name="old-avatar" value="${subscriber.avatar }">
    										<input type="file" class="inputstyle" name="avatar" onchange="loadImageFile()" id="imageInput"  aria-required="true">
										</div>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text"  class="form-control" value="${subscriber.nickname }" name="nickname" required="" aria-required="true">
                                        </div>
                                    </div>
                                    <div class="hr-line-dashed"></div>
									<div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text"  class="form-control"  value="${subscriber.phone }" name="phone" required="" aria-required="true">
                                        </div>
                                    </div>
                                     <div class="hr-line-dashed"></div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">约战成功次数</label>

                                        <div class="col-sm-10">
                                            <input type="number"  class="form-control" value="${subscriber.success }" name="success" required="" aria-required="true">
                                        </div>
                                    </div>
	...
	$(document).ready(function () {
	 if(null!='${subscriber.avatar }'&&""!='${subscriber.avatar }'){
		var newPreview = document.getElementById("imagePreview");   
		oPreviewImg = new Image();   
		oPreviewImg.style.width = "400px";   
		oPreviewImg.style.height = "280px";
		oPreviewImg.src = '${subscriber.avatar }';      
		newPreview.appendChild(oPreviewImg);	
	} 
	 if(null!='${subscriber.teamimg }'&&""!='${subscriber.teamimg }'){
		var newPreview = document.getElementById("imagePreview1");   
		oPreviewImg = new Image();   
		oPreviewImg.style.width = "400px";   
		oPreviewImg.style.height = "280px";
		oPreviewImg.src = '${subscriber.teamimg }';      
		newPreview.appendChild(oPreviewImg);	
	} 
		var flag = false;
